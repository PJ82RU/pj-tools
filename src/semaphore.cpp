...
namespace tools
{
    ...
    bool Semaphore::take(const TickType_t block_time) const
    {
    ...
    bool Semaphore::take(const TickType_t block_time, const char* _func, int _line) const
    {
    ...
    bool Semaphore::give(const char* _func, int _line) const
    {
